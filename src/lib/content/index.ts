...
import donationSettingsData from '../../../content/data/donation-settings.json';
import eventsData from '../../../content/data/events.json';
import projectsData from '../../../content/data/projects.json';
import siteData from '../../../content/data/site.json';
import type { ArtistContent, DonationSettings, EventContent, ProjectContent, SiteContent, SupportFund } from './types';
...
export const donationSettingsContent = donationSettingsData as DonationSettings;
...
export function getDadriSupportContent() {
  return {
    ...
    settings: donationSettingsContent
  };
}
