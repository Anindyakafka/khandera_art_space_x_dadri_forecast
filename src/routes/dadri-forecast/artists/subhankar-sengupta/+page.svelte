<main class="artist-page">
  ...
  <div class="profile-grid" data-flow-copy>
    <article class="profile-card">
      ...
      <p>Subhankar led the open studio "What We Ask, When We Stay" through printmaking, sculpture, projection mapping, and video.</p>
    </article>

    <article class="profile-card">
      <p class="label">Practice</p>
      <h2>Research Through Form</h2>
      <p>His work traces the quiet yet urgent politics of place rooted in the landscapes around Dadri and NTPC, connecting local conditions to wider structures of extraction and erasure.</p>
    </article>

    <article class="profile-card">
      <p class="label">Context</p>
      <h2>Shared Inquiry</h2>
      <p>Through lecture-performance and participatory formats, he opens questions around communal wounds, systemic violence, and the challenge of speaking across generations without simplification.</p>
    </article>
  </div>
